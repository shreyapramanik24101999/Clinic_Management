...
namespace Clinic_MVC.Controllers
{
    public class DoctorsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Department,Name,Degrees,Contact,Day,Time,DocId")] Doctor doctor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Department,Name,Degrees,Contact,Day,Time,DocId")] Doctor doctor)
        {
            if (ModelState.IsValid)
            {
